...
window.LUCKY_WHEEL_DEFAULT_CONFIG = {
  ...
  uiText: {
    en: {
      ...
      resetConfigButton: "Restore Defaults",
      ...
      configImported: "Configuration imported and saved locally.",
      configExported: "Configuration exported. It may contain names; keep it private.",
      configReset: "Saved configuration removed and defaults restored.",
      configImportFailed: "Invalid configuration file. Choose a Lucky Draw Wheel JSON export.",
    ...
    zh: {
      ...
      configImported: "配置已导入并保存在本地。",
      configExported: "配置已导出，文件可能包含姓名，请妥善保管。",
      configReset: "本地配置已清除，并恢复默认设置。",
      configImportFailed: "配置文件无效，请选择本工具导出的 JSON 配置文件。",
